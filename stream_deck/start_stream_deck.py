...
def key_change_callback(deck, key, state):
    ...
    if buttons[button].state == 0:
        ...
        if sum_states == len(NORMAL_BUTTONS):
            ...
            buttons[ALL_BUTTON].image = itertools.cycle(animations["on"][button])
    else:
        turn_off(button)
